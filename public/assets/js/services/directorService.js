/**
 * Created by Desarrollador 1 on 27/04/2016.
 */
...
var DirectorService = function() {
    ...
    function initEventUnLink() {
        $("#unlink").confirm({
            ...
            confirm: function(button) {
                ...
                $.post("/directores/" + directorId + "/unlink", parameters, function( data ) {
                    if(data.success) {
    ...
    function initEventLinkConfirm() {
        $("#modal-confirm").confirm({
            ...
            confirm: function(button) {
                ...
                $.post("/directores/" + directorId + "/link", parameters, function( data ) {
                    if(data.success) {
    ...
    function initSelectedUnLink(){
        $('.advertisers-datatable tbody').on( 'click', 'tr', function () {
    ...
    return {
        init: function() {
            directorId = $("#directorId").data('ids');
            // Events Unlink
            initLinkTable();
            initEventUnLink();
            initEventCancel();
