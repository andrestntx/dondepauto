...
@section('content')
    <div class="col-sm-4 col-md-3" id="urlSearch" data-url="@yield('urlSearch','/directores/' . $user->id .'/anunciantes/search')">
        <div class="ibox ">
            <div class="ibox-content">
                <div class="row m-b-lg">
                    <div class="col-lg-12 text-center" id="directorId" data-ids="{{ $user->id }}">
                        ...
                        <div class="col-sm-8 col-sm-offset-2 col-xs-10 col-xs-offset-1 m-b-sm">
                            <a href="{{ route('directores.edit', $user) }}" class="btn btn-info btn-block">
                    ...
                    <div class="clients-list col-xs-12">
                        <div class="full-height-scroll">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover advertisers-datatable">
                                    <thead>
                                        <tr class="info">
                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <p class="font-bold">Seleccione los anunciantes que asigará al director <strong> {{ $user->name }} </strong> </p>
                                </div>
...
@section('extra-js')
    ...
    <script src="/assets/js/services/directorService.js"></script>
    <script>
        $(document).ready(function() {
            DirectorService.init();
        });
    </script>
@endsection